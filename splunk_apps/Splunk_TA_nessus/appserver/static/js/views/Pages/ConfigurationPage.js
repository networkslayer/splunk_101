...
define([
    ...
    'app/views/Configuration/Server'
], function (
    $,
    _,
    Backbone,
    ...
    return Backbone.View.extend({
        initialize: function () {
            var configuration_template_data = ConfigurationMap.configuration.header,
                ...
                renderMap = {
                    ...
                    'security-center-server': this.renderServer.bind(this),
        ...
        renderServer: function () {
            if (!this.serverRendered) {
                var server_view = new ServerView();
                $('#security-center-server-tab').html(server_view.render().$el);
