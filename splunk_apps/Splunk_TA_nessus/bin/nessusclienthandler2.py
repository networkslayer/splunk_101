            ...
            if self.isReportHostElement == 1 and name != "ReportHost":
                ...
                if self.isReportItemElement == 1 and name != "ReportItem":
                    ...
                    if name == "bid":
                        ...
                        if self.reportItem.get('solution', False):
                            self.reportItem['solution'] += '#####%s' % self.RISolution
                        else:
                            self.reportItem['solution'] = self.RISolution
                        self.isRISolutionElement = 0
                        self.RISolution = ""
